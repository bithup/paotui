...
public class QRCodeUtil {
     ...
     * @throws Exception
     */
    public static String encodeMarketForDeliveryMan(String content, String deliveryManId, String destPath, boolean needCompress) throws Exception {
        BufferedImage image = QRCodeUtil.createImage(content, null, needCompress);
        mkdirs(destPath);
        String fileName = deliveryManId + "." + FORMAT.toLowerCase();
