package com.xgh.paotui.alipay.util;

import com.xgh.paotui.alipay.config.AlipayConfig;
import com.xgh.paotui.alipay.sign.MD5;
...
public class AlipayNotify {
    ...
    public static boolean verify(Map<String, String> params) {
        ...
        logger.info("isSign11111..........." + isSign);
        //写日志记录（若要调试，请取消下面两行注释）
        String sWord = "responseTxt=" + responseTxt + "\n isSign=" + isSign + "\n 返回回来的参数：" + AlipayCoreApp.createLinkString(params);
       /* AlipayCoreApp.logResult(sWord);*/
