...
<head>
    ...
    <script type="text/javascript">
        ...
        function f_getList() {
            ...
            var columns=[{display: "所属城市", name: "openCityName", width: 120, align: "left", type: "string", isSort:true},
                {display: "帐户名", name: "USER_NAME", width: 120, align: "left", type: "string", isSort:true},
                {display: "账号", name: "ACCOUNT", width: 120, align: "left", type: "string", isSort:true},
                {display: "手机", name: "MOBILE", width: 120, align: "left", type: "string", isSort:true},
               // {display: "用户级别", name: "USER_LEVEL", width: 100, align: "left", type: "string", isSort:true,render:function(rowdata, index, value){ return value==1?"负责人":"普通用户";}},
                {display: "是否锁定", name: "IS_LOCK", width: 100, align: "left", type: "string", isSort:true,render:function(rowdata, index, value){ return value==1?"是":"否";}},
                {display: "排序", name: "ORD", width: 80, align: "left", type: "string", isSort:true}];

            $("#listgrid").ligerGrid({
                columns: columns,
                url: url_1,
                parms: [
                    {name: "deptId", value: deptId}, {name: "deptCode", value: deptCode}, {
                        name: "isCascade",
                        value: isCascade
                    }
                ],
        ...
        function h2y_removeUser() {
            ...
            $.post("sys/user/move.htm", {
                op: "out",
                deptUserId: rows[0].DEPT_USER_ID,
                userId: rows[0].ID
            }, function (data) {
